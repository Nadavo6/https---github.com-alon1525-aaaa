...
Coalition::Coalition(Agent firstAgent) : coalitionList(1,firstAgent.getPartyId()),totalMandates(firstAgent.getParty().getMandates()),offeredParties(),selectionPolicy(firstAgent.getSelectionPolicy()),coalitionId(firstAgent.getPartyId())
{
